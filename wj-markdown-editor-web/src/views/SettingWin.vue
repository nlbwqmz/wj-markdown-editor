      ...
      <div style="flex: 1; overflow: auto">
        ...
        >
          ...
          <a-descriptions-item>
            ...
            <a-radio-group
              v-model:value="config.init_route"
              button-style="solid"
            >
          ...
          <a-descriptions-item label="最小化到托盘">
            <a-radio-group
              v-model:value="config.minimize_to_tray"
              button-style="solid"
            >
          ...
          <a-descriptions-item>
            ...
            <a-select
              v-model:value="config.auto_save_minute"
              style="width: 100%"
            >
        ...
        >
          ...
          <a-descriptions-item label="跳转按钮">
            <a-radio-group
              v-model:value="config.jump_router_btn"
              button-style="solid"
            >
              <a-radio-button :value="true">
                显示
          ...
          <a-descriptions-item label="webdav">
            <a-radio-group
              v-model:value="config.show_web_dav"
              button-style="solid"
            >
              <a-radio-button :value="true">
                显示
          ...
          <a-descriptions-item label="默认显示目录">
            <a-radio-group
              v-model:value="config.catalog_show"
              button-style="solid"
            >
              <a-radio-button :value="true">
                是
          ...
          <a-descriptions-item label="预览宽度">
            <a-slider
              v-model:value="config.preview_width"
              :min="10"
              :max="100"
        ...
        >
          ...
          <a-descriptions-item label="代码主题">
            <a-select
              v-model:value="config.code_theme"
              style="width: 100%"
            >
              <a-select-option value="atom">
                atom
              </a-select-option>
              <a-select-option value="a11y">
                a11y
              </a-select-option>
              <a-select-option value="github">
                github
              </a-select-option>
              <a-select-option value="gradient">
                gradient
              </a-select-option>
              <a-select-option value="kimbie">
                kimbie
              </a-select-option>
              <a-select-option value="paraiso">
                paraiso
              </a-select-option>
              <a-select-option value="qtcreator">
                qtcreator
              </a-select-option>
              <a-select-option value="stackoverflow">
                stackoverflow
              </a-select-option>
            </a-select>
          </a-descriptions-item>
          <a-descriptions-item label="预览主题">
            <a-select
              v-model:value="config.preview_theme"
              style="width: 100%"
            >
              ...
              <a-select-option value="vuepress">
                vuepress
              </a-select-option>
              <a-select-option value="mk-cute">
                mk-cute
              </a-select-option>
              <a-select-option value="smart-blue">
                smart-blue
              </a-select-option>
              <a-select-option value="cyanosis">
                cyanosis
              </a-select-option>
            </a-select>
          </a-descriptions-item>
          <a-descriptions-item>
            ...
            <a-radio-group
              v-model:value="config.show_code_row_number"
              button-style="solid"
            >
              <a-radio-button :value="true">
                显示
        ...
        >
          ...
          <a-descriptions-item label="图片保存位置">
            <a-input
              v-model:value="config.img_save_path"
              readonly
            >
              <template #addonAfter>
                <FolderOutlined
          ...
          <a-descriptions-item label="上传本地图片">
            <a-select
              v-model:value="config.insert_local_img_type"
              style="width: 100%"
            >
          ...
          <a-descriptions-item label="粘贴本地图片">
            <a-select
              v-model:value="config.insert_pasteboard_local_img_type"
              style="width: 100%"
            >
              <a-select-option value="1">
                无操作
          ...
          <a-descriptions-item label="上传网络图片">
            <a-select
              v-model:value="config.insert_network_img_type"
              style="width: 100%"
            >
              <a-select-option value="2">
                复制到 ./%{filename} 文件夹
          ...
          <a-descriptions-item label="粘贴网络图片">
            <a-select
              v-model:value="config.insert_pasteboard_network_img_type"
              style="width: 100%"
            >
              <a-select-option value="2">
                复制到 ./%{filename} 文件夹
          ...
          <a-descriptions-item label="截图">
            <a-select
              v-model:value="config.insert_screenshot_img_type"
              style="width: 100%"
            >
              <a-select-option value="2">
                复制到 ./%{filename} 文件夹
        ...
        >
          ...
          <a-descriptions-item label="导出水印">
            <a-radio-group
              v-model:value="config.watermark_enabled"
              button-style="solid"
            >
              <a-radio-button :value="true">
                开启
          ...
          <a-descriptions-item
            label="导出时间"
            v-if="config.watermark_enabled === true"
          >
            <a-radio-group
              v-model:value="config.watermark_export_date"
              button-style="solid"
            >
              <a-radio-button :value="true">
                开启
          ...
          <a-descriptions-item
            label="导出时间格式"
            v-if="config.watermark_enabled === true && config.watermark_export_date === true"
          >
            <a-select
              v-model:value="config.watermark_export_date_format"
              style="width: 100%"
            >
          ...
          >
            <a-slider
              v-model:value="config.watermark_rotate"
              :min="-180"
              :max="180"
            />
          </a-descriptions-item>
          ...
          >
            <a-slider
              v-model:value="config.watermark_gap[0]"
              :min="10"
              :max="500"
            />
          </a-descriptions-item>
          ...
          >
            <a-slider
              v-model:value="config.watermark_gap[1]"
              :min="10"
              :max="500"
            />
          </a-descriptions-item>
          ...
          >
            <a-slider
              v-model:value="config.watermark_font_size"
              :min="12"
              :max="100"
            />
          </a-descriptions-item>
          ...
          >
            <a-slider
              v-model:value="config.watermark_font_weight"
              :min="200"
              :max="1000"
            />
          </a-descriptions-item>
          ...
          >
            <pick-colors
              v-model:value="config.watermark_font_color"
              show-alpha
            />
          </a-descriptions-item>
        </a-descriptions>
        ...
        >
          ...
          <a-descriptions-item label="端口">
            <a-input-number
              v-model:value="config.pic_go_port"
              :min="1"
              style="width: 100%"
            />
          </a-descriptions-item>
        ...
        >
          ...
          <a-descriptions-item>
            ...
            <div style="display: flex">
              <a-input
                v-model:value="config.pandoc_path"
                readonly
                style="flex: 1"
              >
                <template #addonAfter>
                  <FolderOutlined
                    style="cursor: pointer"
                    @click="openDirSelectPandocPath"
                  />
                </template>
              </a-input>
              <a-tooltip
                title="在pandoc目录生成模板文件wj-markdown-editor-reference.docx，用于自定义word样式。(若模板文件存在，不会重新生成。)"
                auto-adjust-overflow
                placement="top"
                color="#1677ff"
              >
                <a-button
                  type="link"
                  v-if="config.pandoc_path"
                  @click="generateDocxTemplate"
                  style="padding-right: 0; padding-left: 0; margin-left: 15px"
                >
                  生成模板文件
                </a-button>
              </a-tooltip>
