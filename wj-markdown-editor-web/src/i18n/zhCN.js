export default {
  ...
  message: {
    ...
    fileManagerCreateEntry: '新建',
    fileManagerCreateFolder: '新建文件夹',
    fileManagerCreateMarkdown: '新建 Markdown',
    fileManagerSort: '排序',
    fileManagerSortNameAsc: '名称升序',
    fileManagerSortNameDesc: '名称降序',
    fileManagerSortModifiedTimeAsc: '修改时间升序',
    fileManagerSortModifiedTimeDesc: '修改时间降序',
    fileManagerSortTypeAsc: '类型升序',
    fileManagerSortTypeDesc: '类型降序',
